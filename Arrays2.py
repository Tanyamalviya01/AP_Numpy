...
print(np.sum(salesArray))

## Step 2: What was Superstore's smallest and largest sale? Print them.
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")

print("Smallest Sale:", np.min(salesArray), "Largest Sale:", np.max(salesArray))
...
print(salesArray * 0.02)
print("Total fees:", round(np.sum(salesArray * 0.02), 2))
